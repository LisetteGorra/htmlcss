...
console.log(stockVolume[i].toLocaleString(), "shares of", stockSymbol[i], "traded yesterday at a price of", sharePrices[i], "for a total of", totalSold.toLocaleString('en-US', {style: 'currency', currency: 'USD'}));
}